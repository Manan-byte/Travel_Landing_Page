...
exports.handler = async function(event, context) {
    ...
    try {
        ...
        const apiUrl = `https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash-preview-05-20:generateContent?key=${AIzaSyAEXxQbembByO74VQeb7CGoqVNPno8n47w}`;
        ...
        if (!response.ok) {
            console.error("Error from Google API:", await response.text());
